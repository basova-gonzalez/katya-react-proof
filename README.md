...
Рабочая ветка: `work/visual-proof`. Восстановленная основа есть в `recovery/old-tab-2026-09-16/` и в Git до незакоммиченных правок Terra. Точный коммит и порядок продолжения указаны в `PLAN.md`.
